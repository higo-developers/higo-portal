                                    ...
                                    <div className="columns is-multiline">
                                                    ...
                                                    <div className="select is-fullwidth">
                                                        <select name="marca" disabled={this.state.brands.length < 1} value={this.state.vehicle.marca} onChange={this.handleBrandChange}>
                                                            {this.state.brands.length > 0 && this.state.brands.map((brand) => {
                                                                return (
                                                                    <option key={brand.id} value={brand.id}>{brand.descripcion}</option>
                                                                )
                                                            })}
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div className="select is-fullwidth">
                                                        <select name="modelo" disabled={this.state.models.length < 1} value={this.state.vehicle.modelo} onChange={this.handleChange}>
                                                            {this.state.models.length > 0 && this.state.models.map((model) => {
                                                                return (
                                                                    <option key={model.id} value={model.id}>{model.descripcion}</option>
                                                                )
                                                            })}
                                                        </select>
                                                    </div>
                                        ...
                                        <div className="column is-one-qarter">
                                            <div className="field">
                                                ...
                                                <div className="control">
                                                    <input name="patente" className="input" type="text" placeholder="Patente" disabled={this.state.vehicle.patente} onChange={this.handleChange} value={this.state.vehicle.patente}/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                                ...
                                                                return (
                                                                    <div className="control" key={cc.id}>
                                                                        <label className="radio">
                                                                            <input type="radio" name="cilindrada" checked={cc.id == this.state.vehicle.cilindrada} onChange={this.handleChange} value={cc.id}/>&nbsp; {cc.descripcion}
                                                                        </label>
                                                                    </div>
                                                                )
                                                            })}
